  ...
  return (
    <>
        <div class='flex flex-col relative' onMouseEnter={() => setOpen(true)} onMouseLeave={() => setOpen(false)}>
            <div onClick={() => setOpen(!open)}  class='flex px-8 text-black font-bold items-center gap-4' style={{borderRadius: '20px', border:'2px solid black' ,backgroundColor:'lightgray'}}>
                <div><p>{title}</p></div>
